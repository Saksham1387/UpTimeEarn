      ...
      <main>
        ...
        <section className="container mx-auto px-6 py-20 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-8">
            Monitor & <span className="text-emerald-400">Earn</span> with Every
            Uptime
          </h1>
          <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
            The first decentralized uptime monitoring platform that rewards you
            for maintaining high availability. Leverage Web3 technology to earn
            while you monitor.
          </p>
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <button
              onClick={() => router.push("/dashboard")}
              className="bg-emerald-500 hover:bg-emerald-600 cursor-pointer px-8 py-4 rounded-lg font-medium flex items-center justify-center space-x-2 transition-colors"
            >
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center p-6">
              ...
              <p className="text-gray-400">
                24/7 uptime monitoring with instant notifications and detailed
                analytics
              </p>
            </div>
            <div className="text-center p-6">
              ...
              <p className="text-gray-400">
                Get rewarded in crypto tokens for maintaining high uptime
                percentages
              </p>
            </div>
            <div className="text-center p-6">
        ...
        <section className="container mx-auto px-6 py-20 text-center">
          <div className="bg-gradient-to-r from-emerald-500/20 to-emerald-700/20 rounded-2xl p-12">
            ...
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              ...
              ensuring their services stay online.
            </p>
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-400">
              © 2024 UpTimeEarn. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
